...
import ToolLibNodeDetail from './details/index.vue'
...
export default { type: WorkflowNodeType.ToolLib, model: WorkflowNodeModel, view: ToolLibNodeView, details: ToolLibNodeDetail }
