  ...
  <NodeContainer :node-model="model">
    ...
    >
      <el-form-item
        ...
        :rules="{ required: true, message: '请选择或填写文生视频模型', trigger: 'change' }"
      >
        <template #label>
      ...
      >
        <template #label>
          <div class="flex items-center gap-1">
            <span>提示词(正向)</span>
            <el-tooltip effect="dark" placement="right" content="正向提示词，用来描述期望生成的视频中应包含的元素和视觉特点。">
