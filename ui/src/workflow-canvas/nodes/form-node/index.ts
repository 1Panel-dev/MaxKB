...
import FormNodeDetail from './details/index.vue'
...
export default { type: WorkflowNodeType.FormNode, model: FormNodeModel, view: FormNodeView, details: FormNodeDetail }
