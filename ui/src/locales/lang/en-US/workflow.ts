export default {
  ...
  setting: {
    ...
    defaultModelSettingTip: 'Nodes that select "Default Model" will use the configuration below.',
    defaultModelNotConfigured: 'Default model not configured',
    defaultModelUnavailable: 'Default model unavailable',
    defaultModelRequired: 'The default model of this type is not configured',
    defaultModelMissing: 'the default model for {modelType} is not configured',
    applyToAll: 'Apply to All Nodes',
    apply: 'Apply',
    applyToAllConfirmMsg: 'All nodes will have their model source set to "Default Model", overriding their current "Custom / Referencing" settings. Proceed with caution.',
    applyToAllSuccess: 'Set {count} node(s) to default model',
    applyToAllNone: 'No node needs to be changed',
    defaultModelSettingUnsaved: 'Default model settings have been modified. Save changes?',
    ...
    modelType: {
      ...
      STT: 'STT Model',
      IMAGE: 'Vision Model',
      TTI: 'Image Generation Model',
      TTV: 'Text-to-Video Model',
      ITV: 'Image-to-Video Model',
