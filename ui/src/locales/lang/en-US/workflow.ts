export default {
  ...
  control: {
    ...
    aiGenerate: 'AI Generate Workflow',
  },
  variable: {
...
-Ensure that the optimized problem accurately reflects the original problem intent and does not alter the original intention.`,
  ...
  aiGenerate: {
    ...
    descriptionPlaceholder: 'Please describe the workflow you want to create, for example: Create a customer service agent that can answer user questions about products, and transfer to human customer service if unable to answer',
    model: 'Select Model',
    modelPlaceholder: 'Please select a model for generating workflow',
    mode: 'Workflow Mode',
    modeApplication: 'Application',
    modeKnowledge: 'Knowledge',
    modeTool: 'Tool',
    generate: 'Generate',
    tips: 'Try these examples:',
    fillRequired: 'Please fill in the description and select a model',
    success: 'Workflow generated successfully',
    error: 'Failed to generate workflow, please try again',
    planDetail: 'View planning details',
