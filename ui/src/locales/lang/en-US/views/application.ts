export default {
  ...
  editChatBackground: 'Edit Chat Background',
  backgroundType: 'Background Type',
  defaultBackground: 'Default Background',
  customBackground: 'Custom Background',
  backgroundUploadTip: 'Supports JPG, PNG, GIF formats, maximum size 10MB',
  backgroundPreview: 'Background Preview',
  editAIAvatar: 'Edit AI Avatar',
  editUserAvatar: 'Edit User Avatar',
  editFloatIcon: 'Edit Float Icon',
  avatarType: 'Avatar Type',
  defaultAvatar: 'Default Avatar',
  customAvatar: 'Custom Avatar',
  avatarUploadTip: 'Supports JPG, PNG, GIF formats, maximum size 10MB',
  displaySettings: 'Display Settings',
  appIcon: 'App Icon',
  chatBackground: 'Chat Background',
  aiAvatar: 'AI Avatar',
  userAvatar: 'User Avatar',
  floatIcon: 'Float Icon',
  edit: 'Edit',
  chatPageConfig: 'Chat Page Configuration',
