export default {
  ...
  ExportLogDialog: {
    ...
    endDate: 'End Date',
    max90Days: 'Maximum export range is 90 days. Please narrow the time range.',
    ...
    fields: {
      ...
      ai_answer: 'AI Answer',
      chat_round: 'Chat Rounds',
      input_tokens: 'Input Tokens',
      output_tokens: 'Output Tokens',
      total_tokens: 'Total Tokens',
      cost: 'Cost',
      model_name: 'Model Name',
      knowledge_calls: 'Knowledge Base Calls',
    ...
    cancel: 'Cancel',
    exporting: 'Exporting...',
    fetchingData: 'Fetching data（{percentage}%）',
    generatingFile: 'Generating file（{percentage}%）',
    estimatedRemaining: 'Estimated remaining: {seconds}s',
    cancelExport: 'Cancel Export',
    exportSuccess: 'Export Successful',
    exportFailed: 'Export Failed: {message}',
    retry: 'Retry',
    noData: 'No log data in the current time range',
  },
