export default {
  ...
  editChatBackground: '編輯聊天背景',
  backgroundType: '背景類型',
  defaultBackground: '預設背景',
  customBackground: '自訂背景',
  backgroundUploadTip: '支援 JPG、PNG、GIF 格式，大小不超過 10MB',
  backgroundPreview: '背景預覽',
  editAIAvatar: '編輯AI頭像',
  editUserAvatar: '編輯用戶頭像',
  editFloatIcon: '編輯浮窗圖示',
  avatarType: '頭像類型',
  defaultAvatar: '預設頭像',
  customAvatar: '自訂頭像',
  avatarUploadTip: '支援 JPG、PNG、GIF 格式，大小不超過 10MB',
