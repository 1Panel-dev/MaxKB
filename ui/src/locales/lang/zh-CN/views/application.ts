export default {
  ...
  editChatBackground: '编辑聊天背景',
  backgroundType: '背景类型',
  defaultBackground: '默认背景',
  customBackground: '自定义背景',
  backgroundUploadTip: '支持 JPG、PNG、GIF 格式，大小不超过 10MB',
  backgroundPreview: '背景预览',
  editAIAvatar: '编辑AI头像',
  editUserAvatar: '编辑用户头像',
  editFloatIcon: '编辑浮窗图标',
  avatarType: '头像类型',
  defaultAvatar: '默认头像',
  customAvatar: '自定义头像',
  avatarUploadTip: '支持 JPG、PNG、GIF 格式，大小不超过 10MB',
