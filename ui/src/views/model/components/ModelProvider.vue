...
<template>
  <div class="px-4">
    ...
    <MkListItem
      ...
      @click="handleProviderSelect(ALL_MODEL_PROVIDER)"
    >
      <MkIcon
        :name="
          modelValue.provider === ALL_MODEL_PROVIDER.provider
            ? 'icon_card_filled'
            : 'icon_card_outlined'
        "
        :size="18"
  ...
  <el-scrollbar class="min-h-0 flex-1 px-4 pb-4">
    <div class="mt-1">
      <MkCollapse
        v-if="publicProviders.length"
        :default-expanded="false"
        triggerClass="hover:bg-N900/10 rounded-md py-[9px] px-2 mb-1"
      >
        <template #label>
