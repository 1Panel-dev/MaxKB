          ...
          <div class="flex-between">
            <div>
              <el-button
                ...
                type="primary"
                @click="router.push({ path: '/knowledge/resource/document/upload/management', query: { id: id } })"
...
import SyncWebDialog from '@/views/resource-management/knowledge/component/SyncWebDialog.vue'
...
import StatusValue from '@/views/resource-management/document/component/Status.vue'
import GenerateRelatedDialog from '@/components/generate-related-dialog/index.vue'
import EmbeddingContentDialog from '@/views/resource-management/document/component/EmbeddingContentDialog.vue'
...
function rowClickHandle(row: any, column: any) {
  ...
  router.push({ path: `/paragraph/resource/${id}/${row.id}/management` })
}
