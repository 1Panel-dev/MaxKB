    ...
    nodes: [
      ...
      },
      {
        ...
        properties: {
          ...
          node_data: {
            knowledge_id_list: [],
            knowledge_setting: { top_n: 3, similarity: 0.6, search_mode: 'embedding', max_paragraph_char_number: 5000 },
            ...
            branch: [
              {
                ...
                type: 'IF',
                condition: 'and',
                conditions: [{ field: ['fd0324fc-f5e4-4fa6-a2d9-cb251b467605', 'is_hit_handling_method_list'], value: 1, compare: 'is_not_null' }],
              },
              {
                id: '6847',
                type: 'ELSE IF 1',
                condition: 'and',
                conditions: [{ field: ['fd0324fc-f5e4-4fa6-a2d9-cb251b467605', 'paragraph_list'], value: 1, compare: 'is_not_null' }],
              },
              { id: '2794', type: 'ELSE', condition: 'and', conditions: [] },
            ],
          },
          branch_condition_list: [
            { index: 0, height: 121.383, id: '7887' },
            { index: 1, height: 121.383, id: '6847' },
            { index: 2, height: 44, id: '2794' },
          ],
        },
      },
      {
        ...
        properties: {
          ...
          stepName: '指定回复',
          condition: 'AND',
          node_data: { fields: ['fd0324fc-f5e4-4fa6-a2d9-cb251b467605', 'directly_return'], content: '', is_result: true, reply_type: 'referencing' },
        },
      },
      {
        ...
        properties: {
          ...
          node_data: {
            ...
            model_setting: { reasoning_content_end: '</think>', reasoning_content_start: '<think>', reasoning_content_enable: false },
            dialogue_number: 1,
          },
        },
      },
      {
        ...
        properties: {
          ...
          stepName: '指定回复1',
          condition: 'AND',
          node_data: { fields: [], content: '抱歉，没有在知识库查询到相关内容，请提供更详细的信息。', is_result: true, reply_type: 'content' },
        },
      },
    ],
    edges: [
      ...
      },
      {
        ...
        endPoint: { x: 1730, y: 120 },
        properties: {},
        pointsList: [
          { x: 1590, y: 793.3089999999999 },
