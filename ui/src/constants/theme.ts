...
export const THEME_OPTIONS = [
  {
    ...
    loginBackground: defaultThemeImage,
  },
  {
    label: '活力橙',
    value: '#ff6000',
    loginBackground: orangeThemeImage,
  },
  {
    label: '松石绿',
    value: '#00b69d',
    loginBackground: greenThemeImage,
  },
  {
    label: '神秘紫',
    value: '#7f3bf5',
    loginBackground: purpleThemeImage,
  },
  {
    label: '胭脂红',
    value: '#f01d94',
    loginBackground: redThemeImage,
  },
] as const
...
export function getThemeImg(themeColor?: string) {
  ...
  return (
    THEME_OPTIONS.find((themeOption) => themeOption.value === normalizedThemeColor)
      ?.loginBackground ?? defaultThemeImage
  )
}
