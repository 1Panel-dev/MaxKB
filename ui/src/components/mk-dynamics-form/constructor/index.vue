...
defineEmits<{
  (event: 'update:modelValue', value: Partial<FormField>): void
}>()
...
const formData = ref<DynamicFormConstructorState>({
  label: '',
  field: '',
  tooltip: '',
  required: false,
  ...
  <el-tabs v-if="enableVisibility" v-model="activeTab">
    <el-tab-pane label="基本信息" name="basic">
      <BasicInfoConstructor
        ref="basicRef"
        v-model="formData"
        :input-type-list="fieldTypeOptions"
        v-bind="$attrs"
      />
    </el-tab-pane>
