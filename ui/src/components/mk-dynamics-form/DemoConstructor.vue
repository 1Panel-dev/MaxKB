...
const leftOptions: Array<LeftOptions> = [
  {
    label: '当前表单',
    value: 'self-form',
    self: true,
    children: [
      { label: '开关', value: 'switch_field', input_type: 'SwitchInput' },
      {
        label: '单选下拉',
        value: 'single_field',
      ...
      { label: '单行文本', value: 'text_field', input_type: 'TextInput' },
      { label: '滑块', value: 'slider_field', input_type: 'Slider' },
    ],
  },
]
