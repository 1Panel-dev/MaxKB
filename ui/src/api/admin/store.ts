...
import type { ApplicationStoreResponse, Dict, ToolItem, ToolStoreResponse } from '@/api/types'
...
const getStoreApplicationList = (query?: Dict<unknown>) => {
  return get<ApplicationStoreResponse>('/workspace/store/application_template', query)
}
