...
const PermissionConst = {
  ...
  APPLICATION_RELATE_RESOURCE_VIEW: new Permission('APPLICATION:READ+RELATE_VIEW'),
  ...
  KNOWLEDGE_DOCUMENT_TOKEN: new Permission('KNOWLEDGE_DOCUMENT:READ+TOKEN'),
  ...
  KNOWLEDGE_TERMBASE_READ: new Permission('KNOWLEDGE_TERMBASE:READ'),
  KNOWLEDGE_TERMBASE_CREATE: new Permission('KNOWLEDGE_TERMBASE:READ+CREATE'),
  KNOWLEDGE_TERMBASE_EDIT: new Permission('KNOWLEDGE_TERMBASE:READ+EDIT'),
  KNOWLEDGE_TERMBASE_DELETE: new Permission('KNOWLEDGE_TERMBASE:READ+DELETE'),
  ...
  SHARED_TOOL_TO_WORKSPACE: new Permission('SYSTEM_TOOL:READ+TO_WORKSPACE'),
  ...
  SHARED_MODEL_TO_WORKSPACE: new Permission('SYSTEM_MODEL:READ+TO_WORKSPACE'),
  ...
  SHARED_KNOWLEDGE_TO_WORKSPACE: new Permission('SYSTEM_KNOWLEDGE:READ+TO_WORKSPACE'),
  ...
  SHARED_KNOWLEDGE_DOCUMENT_TOKEN: new Permission('SYSTEM_KNOWLEDGE_DOCUMENT:READ+TOKEN'),
  ...
  SHARED_KNOWLEDGE_DOCUMENT_DOWNLOAD_SOURCE_FILE: new Permission(
    'SYSTEM_KNOWLEDGE_DOCUMENT:READ+DOWNLOAD',
  ),
  ...
  SHARED_KNOWLEDGE_TERMBASE_READ: new Permission('SYSTEM_KNOWLEDGE_TERMBASE:READ'),
  SHARED_KNOWLEDGE_TERMBASE_CREATE: new Permission('SYSTEM_KNOWLEDGE_TERMBASE:READ+CREATE'),
  SHARED_KNOWLEDGE_TERMBASE_EDIT: new Permission('SYSTEM_KNOWLEDGE_TERMBASE:READ+EDIT'),
  SHARED_KNOWLEDGE_TERMBASE_DELETE: new Permission('SYSTEM_KNOWLEDGE_TERMBASE:READ+DELETE'),
  SHARED_KNOWLEDGE_TERMBASE_EXPORT: new Permission('SYSTEM_KNOWLEDGE_TERMBASE:READ+EXPORT'),
  ...
  RESOURCE_KNOWLEDGE_WORKFLOW_EXPORT: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_WORKFLOW:READ+EXPORT',
  ),

  RESOURCE_KNOWLEDGE_DOCUMENT_READ: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ'),
  RESOURCE_KNOWLEDGE_DOCUMENT_CREATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+CREATE',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_DELETE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+DELETE',
  ),
  ...
  RESOURCE_KNOWLEDGE_DOCUMENT_MIGRATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+MIGRATE',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_VECTOR: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+VECTOR',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_TOKEN: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+TOKEN',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_GENERATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+GENERATE',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_EXPORT: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+EXPORT',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_DOWNLOAD_SOURCE_FILE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+DOWNLOAD',
  ),
  RESOURCE_KNOWLEDGE_DOCUMENT_TAG: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+TAG'),
  RESOURCE_KNOWLEDGE_DOCUMENT_REPLACE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_DOCUMENT:READ+REPLACE',
  ),
  ...
  RESOURCE_KNOWLEDGE_PROBLEM_CREATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_PROBLEM:READ+CREATE',
  ),
  RESOURCE_KNOWLEDGE_PROBLEM_EDIT: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_PROBLEM:READ+EDIT'),
  RESOURCE_KNOWLEDGE_PROBLEM_RELATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_PROBLEM:READ+RELATE',
  ),
  RESOURCE_KNOWLEDGE_PROBLEM_DELETE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_PROBLEM:READ+DELETE',
  ),

  RESOURCE_KNOWLEDGE_TERMBASE_READ: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ'),
  RESOURCE_KNOWLEDGE_TERMBASE_CREATE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+CREATE',
  ),
  RESOURCE_KNOWLEDGE_TERMBASE_EDIT: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+EDIT'),
  RESOURCE_KNOWLEDGE_TERMBASE_DELETE: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+DELETE',
  ),
  RESOURCE_KNOWLEDGE_TERMBASE_EXPORT: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+EXPORT',
  ),

  RESOURCE_KNOWLEDGE_CHAT_USER_READ: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_CHAT_USER:READ'),
  RESOURCE_KNOWLEDGE_CHAT_USER_EDIT: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE_CHAT_USER:READ+EDIT',
  ),
  ...
  RESOURCE_APPLICATION_TRIGGER_READ: new Permission(
    'SYSTEM_RESOURCE_APPLICATION:READ+TRIGGER_READ',
  ),
  RESOURCE_APPLICATION_TRIGGER_CREATE: new Permission(
    'SYSTEM_RESOURCE_APPLICATION:READ+TRIGGER_CREATE',
  ),
  RESOURCE_APPLICATION_TRIGGER_EDIT: new Permission(
    'SYSTEM_RESOURCE_APPLICATION:READ+TRIGGER_EDIT',
  ),
  RESOURCE_APPLICATION_TRIGGER_DELETE: new Permission(
    'SYSTEM_RESOURCE_APPLICATION:READ+TRIGGER_DELETE',
  ),

  RESOURCE_APPLICATION_OVERVIEW_READ: new Permission('SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ'),
  RESOURCE_APPLICATION_OVERVIEW_EMBED: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ+EMBED',
  ),
  RESOURCE_APPLICATION_OVERVIEW_ACCESS: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ+ACCESS',
  ),
  RESOURCE_APPLICATION_OVERVIEW_DISPLAY: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ+DISPLAY',
  ),
  RESOURCE_APPLICATION_OVERVIEW_API_KEY: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ+API_KEY',
  ),
  RESOURCE_APPLICATION_OVERVIEW_PUBLIC: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_OVERVIEW:READ+PUBLIC_ACCESS',
  ),

  RESOURCE_APPLICATION_CHAT_LOG_READ: new Permission('SYSTEM_RESOURCE_APPLICATION_CHAT_LOG:READ'),
  RESOURCE_APPLICATION_CHAT_LOG_ANNOTATION: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_CHAT_LOG:READ+ANNOTATION',
  ),
  RESOURCE_APPLICATION_CHAT_LOG_EXPORT: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_CHAT_LOG:READ+EXPORT',
  ),
  RESOURCE_APPLICATION_CHAT_LOG_CLEAR_POLICY: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_CHAT_LOG:READ+CLEAR_POLICY',
  ),
  RESOURCE_APPLICATION_CHAT_LOG_ADD_KNOWLEDGE: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_CHAT_LOG:READ+ADD_KNOWLEDGE',
  ),
  ...
  RESOURCE_APPLICATION_CHAT_USER_EDIT: new Permission(
    'SYSTEM_RESOURCE_APPLICATION_CHAT_USER:READ+EDIT',
  ),
  ...
  RESOURCE_KNOWLEDGE_RELATE_RESOURCE_VIEW: new Permission(
    'SYSTEM_RESOURCE_KNOWLEDGE:READ+RELATE_VIEW',
  ),
  RESOURCE_MODEL_RELATE_RESOURCE_VIEW: new Permission('SYSTEM_RESOURCE_MODEL:READ+RELATE_VIEW'),
  RESOURCE_APPLICATION_RELATE_RESOURCE_VIEW: new Permission(
    'SYSTEM_RESOURCE_APPLICATION:READ+RELATE_VIEW',
  ),
  ...
  APPLICATION_RESOURCE_AUTHORIZATION: new Permission('APPLICATION:READ+AUTH'),
  KNOWLEDGE_RESOURCE_AUTHORIZATION: new Permission('KNOWLEDGE:READ+AUTH'),
