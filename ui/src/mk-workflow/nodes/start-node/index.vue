...
import NodeContainer from '@/mk-workflow/core/NodeContainer.vue'
import type { WorkflowField } from '@/mk-workflow/core/data'
...
const globalFields = computed(() => (nodeConfig.globalFields ?? []) as unknown as WorkflowField[])
const chatFields = computed(() => (nodeConfig.chatFields ?? []) as unknown as WorkflowField[])
