  ...
  relate_map: (source_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_RELATE_RESOURCE_VIEW.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
        PermissionConst.APPLICATION_RELATE_RESOURCE_VIEW.getWorkspacePermissionWorkspaceManageRole,
      ],
      'OR',
    ),
  publish: (source_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_PUBLISH.getApplicationWorkspaceResourcePermission(source_id),
  ...
  folderCreate: (folder_id: string) =>
    hasPermission(
      [
        new ComplexPermission(
          [RoleConst.USER],
          [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(folder_id)],
          [],
          'AND',
        ),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_CREATE.getApplicationWorkspaceResourcePermission(
          folder_id,
        ),
  ...
  folderRead: (folder_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_READ.getApplicationWorkspaceResourcePermission(
          folder_id,
        ),
  ...
  folderEdit: (folder_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_EDIT.getApplicationWorkspaceResourcePermission(
          folder_id,
        ),
  ...
  folderAuth: (folder_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_AUTH.getApplicationWorkspaceResourcePermission(
          folder_id,
        ),
  ...
  folderDelete: (folder_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_DELETE.getApplicationWorkspaceResourcePermission(
          folder_id,
        ),
  ...
  trigger_read: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_TRIGGER_READ.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  trigger_create: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_TRIGGER_CREATE.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  trigger_edit: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_TRIGGER_EDIT.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  trigger_delete: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_TRIGGER_DELETE.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  auth: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_RESOURCE_AUTHORIZATION.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  overview_embed: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_OVERVIEW_EMBEDDED.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  overview_display: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_OVERVIEW_DISPLAY.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  overview_api_key: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_OVERVIEW_API_KEY.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  access_edit: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_ACCESS_EDIT.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  application_chat_user_edit: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_CHAT_USER_EDIT.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  chat_log_clear: (source_id: string) =>
    hasPermission(
      [
        ...
        PermissionConst.APPLICATION_CHAT_LOG_CLEAR_POLICY.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
  ...
  chat_log_add_knowledge: (source_id: string) =>
    hasPermission(
      [
        ...
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_CHAT_LOG_ADD_KNOWLEDGE
          .getWorkspacePermissionWorkspaceManageRole,
        PermissionConst.APPLICATION_CHAT_LOG_ADD_KNOWLEDGE.getApplicationWorkspaceResourcePermission(
          source_id,
        ),
      ],
      'OR',
