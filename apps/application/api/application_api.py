...
class ApplicationChatBackgroundAPI(APIMixin):
    @staticmethod
    def get_parameters():
        return [
            OpenApiParameter(
...
class ApplicationAvatarAPI(APIMixin):
    @staticmethod
    def get_parameters():
        return [
            OpenApiParameter(
...
class ApplicationUserAvatarAPI(APIMixin):
    @staticmethod
    def get_parameters():
        return [
            OpenApiParameter(
...
class ApplicationFloatIconAPI(APIMixin):
    @staticmethod
    def get_parameters():
        return [
            OpenApiParameter(
