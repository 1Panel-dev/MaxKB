...
class WorkflowManage:
    ...
    def init_fields(self):
        ...
        field_list.sort(key=lambda f: len(f.get('node_name') + f.get('label')), reverse=True)
        global_field_list.sort(key=lambda f: len(f.get('node_name') + f.get('label')), reverse=True)
