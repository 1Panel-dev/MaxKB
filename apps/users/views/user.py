...
class SwitchUserLanguageView(APIView):
    ...
    @log(menu="User management", operate="Switch Language", get_operation_object=lambda r, k: {"name": r.user.username})
    @has_permissions(
        PermissionConstants.SWITCH_LANGUAGE, RoleConstants.ADMIN, RoleConstants.USER, RoleConstants.WORKSPACE_MANAGE
    )
...
class UserManage(APIView):
    ...
    class Page(APIView):
        ...
        def get(self, request: Request, current_page, page_size):
            d = UserManageSerializer.Query(data={**query_params_to_single_dict(request.query_params)})
...
class ResetCurrentUserPasswordView(APIView):
    ...
    @has_permissions(
        PermissionConstants.CHANGE_PASSWORD, RoleConstants.ADMIN, RoleConstants.USER, RoleConstants.WORKSPACE_MANAGE
    )
    def post(self, request: Request):
        request_data = request.data
