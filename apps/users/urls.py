...
urlpatterns = [
    ...
    path('system/workspace/<str:workspace_id>/user_group', views.SystemUserGroupView.as_view()),
    path('system/workspace/<str:workspace_id>/user_group/<str:user_group_id>', views.SystemUserGroupView.Delete.as_view()),
    path('system/workspace/<str:workspace_id>/user_group/<str:user_group_id>/add_member', views.SystemUserGroupView.AddMember.as_view()),
