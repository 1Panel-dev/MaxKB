...
class PermissionConstants(Enum):
    ...
    # ==================== 用户管理 ====================
    USER_READ = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.READ, bit_index=0),
        PermissionMeta(
    ...
    USER_CREATE = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    USER_EDIT = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    USER_DELETE = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    USER_SET_ROLE = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.SET_ROLE, bit_index=4),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    USER_IMPORT = (
        Permission(group=Group.USER, sub_group=Group.USER, operate=Operate.IMPORT, bit_index=5),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    # ==================== 系统用户组 ====================
    SYSTEM_USER_GROUP_READ = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.READ, bit_index=0),
        PermissionMeta(
    ...
    SYSTEM_USER_GROUP_CREATE = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    SYSTEM_USER_GROUP_EDIT = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    SYSTEM_USER_GROUP_DELETE = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    SYSTEM_USER_GROUP_ADD_MEMBER = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.ADD_MEMBER, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    SYSTEM_USER_GROUP_REMOVE_MEMBER = (
        Permission(group=Group.USER_GROUP, sub_group=Group.USER_GROUP, operate=Operate.REMOVE_MEMBER, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    # ==================== 触发器 ====================
    TRIGGER_READ = (
        Permission(group=Group.TRIGGER, sub_group=Group.TRIGGER, operate=Operate.READ, bit_index=0),
        PermissionMeta(
    ...
    TRIGGER_EDIT = (
        Permission(group=Group.TRIGGER, sub_group=Group.TRIGGER, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.WORKSPACE_MANAGE],
            category=Category.WORKSPACE,
            scope=[PermissionScopeConstants.WORKSPACE_RESOURCE],
    ...
    TRIGGER_DELETE = (
        Permission(group=Group.TRIGGER, sub_group=Group.TRIGGER, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.WORKSPACE_MANAGE],
            category=Category.WORKSPACE,
            scope=[PermissionScopeConstants.WORKSPACE_RESOURCE],
    ...
    TRIGGER_RECORD = (
        Permission(group=Group.TRIGGER, sub_group=Group.TRIGGER, operate=Operate.RECORD, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.WORKSPACE_MANAGE],
            category=Category.WORKSPACE,
            scope=[PermissionScopeConstants.WORKSPACE_RESOURCE],
    ...
    KNOWLEDGE_RESOURCE_AUTHORIZATION = (
    ...
    KNOWLEDGE_RELATE_RESOURCE_VIEW = (
    ...
    KNOWLEDGE_DOCUMENT_DOWNLOAD_SOURCE_FILE = (
    ...
    TOOL_RESOURCE_PERMISSION_READ = (
        Permission(
            group=Group.RESOURCE_PERMISSION, sub_group=Group.TOOL_RESOURCE_PERMISSION, operate=Operate.READ, bit_index=4
        ),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
    ...
    # ==================== 邮件设置 ====================
    EMAIL_SETTING_READ = (
        Permission(group=Group.EMAIL_SETTING, sub_group=Group.EMAIL_SETTING, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.SYSTEM_SETTING, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )

    EMAIL_SETTING_EDIT = (
        Permission(group=Group.EMAIL_SETTING, sub_group=Group.EMAIL_SETTING, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.SYSTEM_SETTING, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
    ...
    # ==================== 角色管理 ====================
    ROLE_READ = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    ROLE_CREATE = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    ROLE_EDIT = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    ROLE_DELETE = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(role_list=[RoleConstants.ADMIN], category=Category.IAM, scope=[PermissionScopeConstants.SYSTEM]),
    )

    ROLE_ADD_MEMBER = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.ADD_MEMBER, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    ROLE_REMOVE_MEMBER = (
        Permission(group=Group.ROLE, sub_group=Group.ROLE, operate=Operate.REMOVE_MEMBER, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    # ==================== 工作空间管理 ====================
    WORKSPACE_READ = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            is_ee=is_ee,
    ...
    WORKSPACE_CREATE = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.IAM, is_ee=is_ee, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )

    WORKSPACE_EDIT = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.IAM, is_ee=is_ee, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
    ...
    WORKSPACE_DELETE = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.IAM, is_ee=is_ee, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
    ...
    WORKSPACE_ADD_MEMBER = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.ADD_MEMBER, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            is_ee=is_ee,
    ...
    WORKSPACE_REMOVE_MEMBER = (
        Permission(group=Group.WORKSPACE, sub_group=Group.WORKSPACE, operate=Operate.REMOVE_MEMBER, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.IAM,
            is_ee=is_ee,
    ...
    # ==================== 登录认证 ====================
    LOGIN_AUTH_READ = (
        Permission(group=Group.LOGIN_AUTH, sub_group=Group.LOGIN_AUTH, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.SYSTEM_SETTING, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
    ...
    LOGIN_AUTH_EDIT = (
        Permission(group=Group.LOGIN_AUTH, sub_group=Group.LOGIN_AUTH, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.SYSTEM_SETTING, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
    ...
    APPLICATION_RELATE_RESOURCE_VIEW = (
    ...
    APPLICATION_CHAT_LOG_ANNOTATION = (
    ...
    APPLICATION_CHAT_LOG_CLEAR_POLICY = (
    ...
    APPLICATION_CHAT_LOG_ADD_KNOWLEDGE = (
    ...
    # ==================== 对话用户 ====================
    CHAT_USER_READ = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
        ),
    )

    CHAT_USER_CREATE = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    CHAT_USER_SYNC = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.SYNC, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    CHAT_USER_EDIT = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.EDIT, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    CHAT_USER_DELETE = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.DELETE, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    CHAT_USER_GROUP = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.USER_GROUP, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    CHAT_USER_QUOTA_SETTING = (
        Permission(group=Group.CHAT_USER, sub_group=Group.CHAT_USER, operate=Operate.QUOTA_SETTING, bit_index=6),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    # ==================== 对话用户组 ====================
    USER_GROUP_READ = (
        Permission(group=Group.CHAT_USER_GROUP, sub_group=Group.CHAT_USER_GROUP, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    USER_GROUP_CREATE = (
        Permission(group=Group.CHAT_USER_GROUP, sub_group=Group.CHAT_USER_GROUP, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    USER_GROUP_EDIT = (
        Permission(group=Group.CHAT_USER_GROUP, sub_group=Group.CHAT_USER_GROUP, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    USER_GROUP_DELETE = (
        Permission(group=Group.CHAT_USER_GROUP, sub_group=Group.CHAT_USER_GROUP, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN, RoleConstants.WORKSPACE_MANAGE],
            category=Category.CHAT_CLIENT,
            scope=[PermissionScopeConstants.SYSTEM],
    ...
    PORTAL_READ = (
        Permission(group=Group.PORTAL, sub_group=Group.PORTAL, operate=Operate.READ, bit_index=0),
        PermissionMeta(role_list=[RoleConstants.ADMIN], scope=[PermissionScopeConstants.SYSTEM]),
    )

    PORTAL_EDIT = (
        Permission(group=Group.PORTAL, sub_group=Group.PORTAL, operate=Operate.EDIT, bit_index=0),
        PermissionMeta(role_list=[RoleConstants.ADMIN], scope=[PermissionScopeConstants.SYSTEM]),
    )

    # ==================== 共享工具 ====================
    SHARED_TOOL_READ = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
    ...
    SHARED_TOOL_CREATE = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_EDIT = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_DELETE = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_IMPORT = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.IMPORT, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_EXPORT = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.EXPORT, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_PUBLISH = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.PUBLISH, bit_index=6),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_RELATE_RESOURCE_VIEW = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.RELATE_VIEW, bit_index=7),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_EXECUTE_RECORD = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.RECORD, bit_index=8),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_TOOL_TO_WORKSPACE = (
        Permission(group=Group.SYSTEM_TOOL, sub_group=Group.SYSTEM_TOOL, operate=Operate.TO_WORKSPACE, bit_index=9),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_CREATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_SYNC = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.SYNC, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_VECTOR = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.VECTOR, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_EXPORT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.EXPORT, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DELETE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_KNOWLEDGE, operate=Operate.DELETE, bit_index=7),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_RELATE_RESOURCE_VIEW = (
        Permission(
    ...
    # 共享知识库工作流
    SHARED_KNOWLEDGE_WORKFLOW_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_WORKFLOW, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_WORKFLOW_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_WORKFLOW, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_WORKFLOW_EXPORT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_WORKFLOW, operate=Operate.EXPORT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_WORKFLOW_PUBLISH = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_WORKFLOW, operate=Operate.PUBLISH, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # 共享知识库文档
    SHARED_KNOWLEDGE_DOCUMENT_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_CREATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_DELETE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_SYNC = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.SYNC, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_EXPORT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.EXPORT, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_DOWNLOAD_SOURCE_FILE = (
        Permission(
    ...
    SHARED_KNOWLEDGE_DOCUMENT_GENERATE = (
        Permission(
    ...
    SHARED_KNOWLEDGE_DOCUMENT_VECTOR = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.VECTOR, bit_index=8),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_MIGRATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.MIGRATE, bit_index=9),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_TAG = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.TAG, bit_index=10),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_DOCUMENT_REPLACE = (
        Permission(
    ...
    SHARED_KNOWLEDGE_DOCUMENT_TOKEN = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_DOCUMENT, operate=Operate.TOKEN, bit_index=12),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # 共享知识库标签
    SHARED_KNOWLEDGE_TAG_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TAG_CREATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TAG_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TAG_DELETE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_PROBLEM_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_PROBLEM_CREATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_PROBLEM_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_PROBLEM_DELETE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_PROBLEM_RELATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.RELATE, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # 共享知识库术语库
    SHARED_KNOWLEDGE_TERMBASE_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TERMBASE, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TERMBASE_CREATE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TERMBASE, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TERMBASE_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TERMBASE, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TERMBASE_DELETE = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TERMBASE, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_TERMBASE_EXPORT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_TERMBASE, operate=Operate.EXPORT, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # 共享知识库命中测试
    SHARED_KNOWLEDGE_HIT_TEST = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_HIT_TEST, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # 共享知识库对话用户
    SHARED_KNOWLEDGE_CHAT_USER_READ = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_CHAT_USER, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_KNOWLEDGE_CHAT_USER_EDIT = (
        Permission(group=Group.SYSTEM_KNOWLEDGE, sub_group=Group.SYSTEM_CHAT_USER, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # ==================== 共享模型 ====================
    SHARED_MODEL_READ = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_MODEL_CREATE = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_MODEL_EDIT = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_MODEL_DELETE = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_MODEL_RELATE_RESOURCE_VIEW = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.RELATE_VIEW, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    SHARED_MODEL_TO_WORKSPACE = (
        Permission(group=Group.SYSTEM_MODEL, sub_group=Group.SYSTEM_MODEL, operate=Operate.TO_WORKSPACE, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.SHARED,
            is_ee=is_ee,
    ...
    # ==================== 资源管理 - 应用 ====================
    RESOURCE_APPLICATION_READ = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
            operate=Operate.READ,
            bit_index=0,
        ),
        PermissionMeta(
    ...
    RESOURCE_APPLICATION_PUBLISH = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
            operate=Operate.PUBLISH,
            bit_index=6,
        ),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
    ...
    RESOURCE_APPLICATION_TRIGGER_READ = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
    ...
    RESOURCE_APPLICATION_TRIGGER_CREATE = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
    ...
    RESOURCE_APPLICATION_TRIGGER_EDIT = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
    ...
    RESOURCE_APPLICATION_TRIGGER_DELETE = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
    ...
    RESOURCE_APPLICATION_RELATE_RESOURCE_VIEW = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_RES_APPLICATION,
    ...
    # 资源管理 - 应用概览
    RESOURCE_APPLICATION_OVERVIEW_READ = (
        Permission(
    ...
    RESOURCE_APPLICATION_OVERVIEW_EMBED = (
        Permission(
    ...
    RESOURCE_APPLICATION_OVERVIEW_ACCESS = (
        Permission(
    ...
    RESOURCE_APPLICATION_OVERVIEW_DISPLAY = (
        Permission(
    ...
    RESOURCE_APPLICATION_OVERVIEW_API_KEY = (
        Permission(
    ...
    RESOURCE_APPLICATION_OVERVIEW_PUBLIC = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_OVERVIEW,
    ...
    # 资源管理 - 应用接入
    RESOURCE_APPLICATION_ACCESS_READ = (
        Permission(
    ...
    RESOURCE_APPLICATION_ACCESS_EDIT = (
        Permission(
    ...
    # 资源管理 - 应用对话用户
    RESOURCE_APPLICATION_CHAT_USER_READ = (
        Permission(
    ...
    RESOURCE_APPLICATION_CHAT_USER_EDIT = (
        Permission(
    ...
    # 资源管理 - 应用对话日志
    RESOURCE_APPLICATION_CHAT_LOG_READ = (
        Permission(
    ...
    RESOURCE_APPLICATION_CHAT_LOG_ADD_KNOWLEDGE = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_CHAT_LOG,
    ...
    RESOURCE_APPLICATION_CHAT_LOG_ANNOTATION = (
        Permission(
    ...
    RESOURCE_APPLICATION_CHAT_LOG_EXPORT = (
        Permission(
    ...
    RESOURCE_APPLICATION_CHAT_LOG_CLEAR_POLICY = (
        Permission(
            group=Group.SYSTEM_RES_APPLICATION,
            sub_group=Group.SYSTEM_CHAT_LOG,
    ...
    RESOURCE_KNOWLEDGE_GENERATE = (
        Permission(
            group=Group.SYSTEM_RES_KNOWLEDGE,
            sub_group=Group.SYSTEM_RES_KNOWLEDGE,
    ...
    RESOURCE_KNOWLEDGE_RELATE_RESOURCE_VIEW = (
        Permission(
            group=Group.SYSTEM_RES_KNOWLEDGE,
            sub_group=Group.SYSTEM_RES_KNOWLEDGE,
            operate=Operate.RELATE_VIEW,
    ...
    # 资源管理 - 知识库工作流
    RESOURCE_KNOWLEDGE_WORKFLOW_READ = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_WORKFLOW_EDIT = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_WORKFLOW_EXPORT = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_WORKFLOW_PUBLISH = (
        Permission(
    ...
    # 资源管理 - 知识库文档
    RESOURCE_KNOWLEDGE_DOCUMENT_READ = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_CREATE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_EDIT = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_DELETE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_SYNC = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_EXPORT = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_GENERATE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_VECTOR = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_MIGRATE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_TAG = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_REPLACE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_DOCUMENT_TOKEN = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_PROBLEM_READ = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_KNOWLEDGE_PROBLEM_CREATE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_PROBLEM_EDIT = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_PROBLEM, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_KNOWLEDGE_PROBLEM_DELETE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_PROBLEM_RELATE = (
        Permission(
    ...
    # 资源管理 - 知识库术语库
    RESOURCE_KNOWLEDGE_TERMBASE_READ = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_TERMBASE_CREATE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_TERMBASE_EDIT = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_TERMBASE_DELETE = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_TERMBASE_EXPORT = (
        Permission(
    ...
    # 资源管理 - 知识库标签
    RESOURCE_KNOWLEDGE_TAG_READ = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_KNOWLEDGE_TAG_CREATE = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.CREATE, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_KNOWLEDGE_TAG_EDIT = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.EDIT, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_KNOWLEDGE_TAG_DELETE = (
        Permission(group=Group.SYSTEM_RES_KNOWLEDGE, sub_group=Group.SYSTEM_TAG, operate=Operate.DELETE, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    # 资源管理 - 知识库对话用户
    RESOURCE_KNOWLEDGE_CHAT_USER_READ = (
        Permission(
    ...
    RESOURCE_KNOWLEDGE_CHAT_USER_EDIT = (
        Permission(
    ...
    # ==================== 资源管理 - 工具 ====================
    RESOURCE_TOOL_READ = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_EDIT = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_DELETE = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.DELETE, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_EXPORT = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.EXPORT, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_PUBLISH = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.PUBLISH, bit_index=4),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_AUTH = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.AUTH, bit_index=5),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_TOOL_RELATE_RESOURCE_VIEW = (
        Permission(
    ...
    RESOURCE_TOOL_EXECUTE_RECORD = (
        Permission(group=Group.SYSTEM_RES_TOOL, sub_group=Group.SYSTEM_RES_TOOL, operate=Operate.RECORD, bit_index=7),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    # ==================== 资源管理 - 模型 ====================
    RESOURCE_MODEL_READ = (
        Permission(group=Group.SYSTEM_RES_MODEL, sub_group=Group.SYSTEM_RES_MODEL, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_MODEL_EDIT = (
        Permission(group=Group.SYSTEM_RES_MODEL, sub_group=Group.SYSTEM_RES_MODEL, operate=Operate.EDIT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_MODEL_DELETE = (
        Permission(group=Group.SYSTEM_RES_MODEL, sub_group=Group.SYSTEM_RES_MODEL, operate=Operate.DELETE, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_MODEL_AUTH = (
        Permission(group=Group.SYSTEM_RES_MODEL, sub_group=Group.SYSTEM_RES_MODEL, operate=Operate.AUTH, bit_index=3),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN],
            category=Category.RESOURCE,
            is_ee=is_ee,
    ...
    RESOURCE_MODEL_RELATE_RESOURCE_VIEW = (
        Permission(
    ...
    # ==================== 操作日志 ====================
    OPERATION_LOG_READ = (
        Permission(group=Group.OPERATION_LOG, sub_group=Group.OPERATION_LOG, operate=Operate.READ, bit_index=0),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.OPERATION_LOG, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )

    OPERATION_LOG_EXPORT = (
        Permission(group=Group.OPERATION_LOG, sub_group=Group.OPERATION_LOG, operate=Operate.EXPORT, bit_index=1),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.OPERATION_LOG, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )

    OPERATION_LOG_CLEAR_POLICY = (
        Permission(group=Group.OPERATION_LOG, sub_group=Group.OPERATION_LOG, operate=Operate.CLEAR_POLICY, bit_index=2),
        PermissionMeta(
            role_list=[RoleConstants.ADMIN], category=Category.OPERATION_LOG, scope=[PermissionScopeConstants.SYSTEM]
        ),
    )
...
# 权限字符串与权限对象的Map
PERMISSION_STR_MAP = {_permission.value.__str__(): _permission for _permission in PermissionConstants}
