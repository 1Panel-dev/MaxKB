...
class ToolExecutor:
    ...
    def init_sandbox_dir():
        ...
        if banned_hosts:
            ...
            banned_hosts = ",".join(
                s.strip() for s in banned_hosts.split(",") if s.strip() and s.strip().lower() != hostname.lower())
...
"""
    ...
    def _exec(self, execute_file, _id):
        ...
        def _set_resource_limit():
            ...
            with suppress(Exception): os.sched_setaffinity(0, set(random.sample(list(os.sched_getaffinity(0)),
