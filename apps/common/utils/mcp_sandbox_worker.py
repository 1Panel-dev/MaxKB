...
AddrInfo._fields_ = [
    ("flags", ctypes.c_int), ("family", ctypes.c_int), ("socktype", ctypes.c_int),
    ("protocol", ctypes.c_int), ("addrlen", ctypes.c_uint), ("addr", ctypes.c_void_p),
    ("canonname", ctypes.c_char_p), ("next", ctypes.POINTER(AddrInfo)),
]
...
class SandboxNetworkCheck:
    ...
    def __init__(self, library):
        ...
        self.getaddrinfo.argtypes = [
            ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(AddrInfo), ctypes.POINTER(ctypes.POINTER(AddrInfo)),
        ]
