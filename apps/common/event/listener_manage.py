...
class ListenerManagement:
    ...
    def embedding_by_paragraph_list(paragraph_id_list, embedding_model: Embeddings):
        try:
            ...
            ListenerManagement.embedding_by_paragraph_data_list(
                data_list, paragraph_id_list=paragraph_id_list, embedding_model=embedding_model
            )
    ...
    def get_aggregation_document_status_by_knowledge_id(knowledge_id):
        def aggregation_document_status():
            ...
            native_update(
                {"document_custom_sql": QuerySet(Document).filter(knowledge_id=knowledge_id)}, sql, with_table_name=True
            )
    ...
    def post_update_document_status(document_id, task_type: TaskType):
        ...
        ListenerManagement.update_status(
            ...
            .annotate(
                ...
                task_type_status=Substr("reversed_status", task_type.value, task_type.value),
            )
