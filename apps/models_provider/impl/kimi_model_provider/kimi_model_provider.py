...
moonshot_v1_8k = ModelInfo("moonshot-v1-8k", "", ModelTypeConst.LLM, kimi_llm_model_credential, KimiChatModel)
moonshot_v1_32k = ModelInfo("moonshot-v1-32k", "", ModelTypeConst.LLM, kimi_llm_model_credential, KimiChatModel)
moonshot_v1_128k = ModelInfo("moonshot-v1-128k", "", ModelTypeConst.LLM, kimi_llm_model_credential, KimiChatModel)
    ...
    def get_model_provide_info(self):
        return ModelProvideInfo(
            ...
            icon=get_file_content(
                os.path.join(
                    PROJECT_DIR, "apps", "models_provider", "impl", "kimi_model_provider", "icon", "kimi_icon_svg"
                )
            ),
        )
