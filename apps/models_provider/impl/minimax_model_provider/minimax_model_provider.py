...
minimax_tti_list = [
    ModelInfo('image-01',
              _(''),
              ModelTypeConst.TTI,
              minimax_tti_model_credential, MiniMaxTextToImageModel),
]
minimax_ttv_list = [
    ModelInfo('MiniMax-Hailuo-2.3',
              _(''),
              ModelTypeConst.TTV,
              minimax_ttv_model_credential, GenerationVideoModel),
]
...
model_info_manage = (
    ...
    .append_model_info_list(minimax_tti_list).append_default_model_info(minimax_tti_list[0])
    .append_model_info_list(minimax_ttv_list).append_default_model_info(minimax_ttv_list[0])
    .build()
)
