...
model_info_list = [
    ModelInfo("ai/qwen3-vl:8B", "", ModelTypeConst.LLM, docker_ai_llm_model_credential, DockerAIChatModel),
]
open_ai_embedding_credential = DockerAIEmbeddingCredential()
model_info_embedding_list = [
    ModelInfo(
        "ai/qwen3-embedding-vllm", "", ModelTypeConst.EMBEDDING, open_ai_embedding_credential, DockerAIEmbeddingModel
    ),
]
...
model_info_rerank_list = [
    ModelInfo(
        "ai/qwen3-reranker:0.6B", "", ModelTypeConst.RERANKER, docker_ai_reranker_model_credential, DockerAIReranker
    ),
]
model_info_manage = (
