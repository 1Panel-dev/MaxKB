...
def _get_aws_bedrock_icon_path():
    return os.path.join(
        PROJECT_DIR, "apps", "models_provider", "impl", "aws_bedrock_model_provider", "icon", "bedrock_icon_svg"
    )
...
def _initialize_model_info():
    ...
    reranker_model_info_list = [
        _create_model_info(
            "amazon.rerank-v1:0", "", ModelTypeConst.RERANKER, BedrockRerankerCredential, BedrockRerankerModel
        ),
        _create_model_info(
            "cohere.rerank-v3-5:0", "", ModelTypeConst.RERANKER, BedrockRerankerCredential, BedrockRerankerModel
        ),
    ]
    vl_model_info_list = [
        _create_model_info(
...
class BedrockModelProvider(IModelProvider):
    ...
    def get_model_provide_info(self):
        ...
        return ModelProvideInfo(provider="model_aws_bedrock_provider", name="Amazon Bedrock", icon=icon_data)
