...
model_info_list = [
    ...
    ModelInfo("qianfan-chinese-llama-2-13b", "", ModelTypeConst.LLM, win_xin_llm_model_credential, QianfanChatModel),
    ModelInfo("ernie-4.5-turbo-32k", "", ModelTypeConst.LLM, win_xin_llm_model_credential, QianfanChatModel),
...
embedding_model_info_list = [
    ...
    ModelInfo("tao-8k", "", ModelTypeConst.EMBEDDING, qianfan_embedding_credential, QianfanEmbeddings),
    ModelInfo("bge-large-zh", "", ModelTypeConst.EMBEDDING, qianfan_embedding_credential, QianfanEmbeddings),
]
rerank_model_info_list = [
    ModelInfo("bce-reranker-base", _(""), ModelTypeConst.RERANKER, qf_reranker_credential, QfBgeReranker),
]
model_info_manage = (
    ...
    def get_model_provide_info(self):
        return ModelProvideInfo(
            ...
            icon=get_file_content(
                os.path.join(
                    PROJECT_DIR, "apps", "models_provider", "impl", "wenxin_model_provider", "icon", "azure_icon_svg"
                )
            ),
        )
