...
from models_provider.impl.siliconCloud_model_provider.credential.embedding import SiliconCloudEmbeddingCredential
...
from models_provider.impl.siliconCloud_model_provider.credential.tti import SiliconCloudTextToImageModelCredential
...
model_info_list = [
    ...
    ModelInfo("Qwen/Qwen2.5-7B-Instruct", "", ModelTypeConst.LLM, openai_llm_model_credential, SiliconCloudChatModel),
    ModelInfo(
        "Qwen/Qwen2.5-Coder-7B-Instruct", "", ModelTypeConst.LLM, openai_llm_model_credential, SiliconCloudChatModel
    ),
    ModelInfo(
        "internlm/internlm2_5-7b-chat", "", ModelTypeConst.LLM, openai_llm_model_credential, SiliconCloudChatModel
    ),
    ModelInfo("Qwen/Qwen2-1.5B-Instruct", "", ModelTypeConst.LLM, openai_llm_model_credential, SiliconCloudChatModel),
    ModelInfo("THUDM/glm-4-9b-chat", "", ModelTypeConst.LLM, openai_llm_model_credential, SiliconCloudChatModel),
    ModelInfo(
        "FunAudioLLM/SenseVoiceSmall", "", ModelTypeConst.STT, openai_stt_model_credential, SiliconCloudSpeechToText
    ),
]
...
model_info_embedding_list = [
    ...
    ModelInfo("BAAI/bge-m3", "", ModelTypeConst.EMBEDDING, open_ai_embedding_credential, SiliconCloudEmbeddingModel),
    ModelInfo(
        "BAAI/bge-large-en-v1.5", "", ModelTypeConst.EMBEDDING, open_ai_embedding_credential, SiliconCloudEmbeddingModel
    ),
    ModelInfo(
        "BAAI/bge-large-zh-v1.5", "", ModelTypeConst.EMBEDDING, open_ai_embedding_credential, SiliconCloudEmbeddingModel
    ),
]
...
model_info_tti_list = [
    ...
    ModelInfo(
        "black-forest-labs/FLUX.1-schnell", "", ModelTypeConst.TTI, openai_tti_model_credential, SiliconCloudTextToImage
    ),
    ModelInfo(
    ...
    ModelInfo(
        "stabilityai/stable-diffusion-2-1", "", ModelTypeConst.TTI, openai_tti_model_credential, SiliconCloudTextToImage
    ),
]
model_rerank_list = [
    ModelInfo(
    ...
    ModelInfo(
        "BAAI/bge-reranker-v2-m3", "", ModelTypeConst.RERANKER, openai_reranker_model_credential, SiliconCloudReranker
    ),
]
model_tts_list = [
    ModelInfo(
        "FunAudioLLM/CosyVoice2-0.5B", "", ModelTypeConst.TTS, openai_tts_model_credential, SiliconCloudTextToSpeech
    ),
]
model_image_info_list = [
    ModelInfo("Qwen/Qwen3-VL-32B-Instruct", "", ModelTypeConst.IMAGE, openai_image_model_credential, SiliconCloudImage),
]
model_info_manage = (
    ...
    .append_default_model_info(
        ModelInfo("whisper-1", "", ModelTypeConst.STT, openai_stt_model_credential, SiliconCloudSpeechToText)
    )
