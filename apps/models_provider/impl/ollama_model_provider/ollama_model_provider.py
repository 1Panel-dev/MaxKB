...
model_info_list = [
    ModelInfo("deepseek-r1:1.5b", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("deepseek-r1:7b", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("deepseek-r1:8b", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("deepseek-r1:14b", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("deepseek-r1:32b", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo(
        "llama2",
        _(
    ...
    ModelInfo("qwen2:72b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2:57b-a14b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2:7b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:72b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:32b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:14b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:7b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:1.5b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:0.5b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo("qwen2.5:3b-instruct", "", ModelTypeConst.LLM, ollama_llm_model_credential, OllamaChatModel),
    ModelInfo(
        "phi3",
...
image_model_info = [
    ModelInfo("llava:7b", "", ModelTypeConst.IMAGE, ollama_image_model_credential, OllamaImage),
    ModelInfo("llava:13b", "", ModelTypeConst.IMAGE, ollama_image_model_credential, OllamaImage),
    ModelInfo("llava:34b", "", ModelTypeConst.IMAGE, ollama_image_model_credential, OllamaImage),
]
    ...
    def get_model_provide_info(self):
        return ModelProvideInfo(
            ...
            icon=get_file_content(
                os.path.join(
                    PROJECT_DIR, "apps", "models_provider", "impl", "ollama_model_provider", "icon", "ollama_icon_svg"
                )
            ),
        )
