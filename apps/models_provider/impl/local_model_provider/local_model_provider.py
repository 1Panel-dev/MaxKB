...
embedding_text2vec_base_chinese = ModelInfo(
    "shibing624/text2vec-base-chinese", "", ModelTypeConst.EMBEDDING, LocalEmbeddingCredential(), LocalEmbedding
)
bge_reranker_v2_m3 = ModelInfo(
    "BAAI/bge-reranker-v2-m3", "", ModelTypeConst.RERANKER, LocalRerankerCredential(), LocalReranker
)
    ...
    def get_model_provide_info(self):
        return ModelProvideInfo(
            ...
            icon=get_file_content(
                os.path.join(
                    PROJECT_DIR, "apps", "models_provider", "impl", "local_model_provider", "icon", "local_icon_svg"
                )
            ),
        )
