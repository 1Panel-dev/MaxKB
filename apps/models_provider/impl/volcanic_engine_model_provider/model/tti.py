...
class VolcanicEngineTextToImage(MaxKBBaseModel, BaseTextToImage):
    ...
    def new_instance(model_type, model_name, model_credential: Dict[str, object], **model_kwargs):
        ...
        return VolcanicEngineTextToImage(
            ...
            api_base=model_credential.get("volcanic_api_url") or "https://ark.cn-beijing.volces.com/api/v3",
            **optional_params,
        )
    ...
    def generate_image(self, prompt: str, negative_prompt: str = None):
        ...
        file_urls = []
        imagesResponse = client.images.generate(model=self.model_version, prompt=prompt, **self.params)
        # 如果 data 是列表，遍历所有图片
