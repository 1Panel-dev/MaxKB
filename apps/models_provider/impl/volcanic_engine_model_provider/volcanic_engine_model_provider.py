...
from models_provider.impl.volcanic_engine_model_provider.credential.image import VolcanicEngineImageModelCredential
...
model_info_list = [
    ...
    ModelInfo("asr", "", ModelTypeConst.STT, volcanic_engine_stt_model_credential, VolcanicEngineSpeechToText),
    ModelInfo(
...
model_info_ttv_list = [
    ModelInfo("doubao-seedance-1-0-pro-250528", _(""), ModelTypeConst.TTV, ttv_credential, GenerationVideoModel),
    ModelInfo("doubao-seedance-1-0-lite-t2v-250428", _(""), ModelTypeConst.TTV, ttv_credential, GenerationVideoModel),
    ModelInfo("wan2-1-14b-t2v-250225", _(""), ModelTypeConst.TTV, ttv_credential, GenerationVideoModel),
]
model_info_itv_list = [
    ModelInfo("doubao-seedance-1-0-pro-250528", _(""), ModelTypeConst.ITV, ttv_credential, GenerationVideoModel),
    ModelInfo("doubao-seedance-1-0-lite-i2v-250428", _(""), ModelTypeConst.ITV, ttv_credential, GenerationVideoModel),
    ModelInfo("wan2-1-14b-i2v-250225", _(""), ModelTypeConst.ITV, ttv_credential, GenerationVideoModel),
    ModelInfo("wan2-1-14b-flf2v-250417", _(""), ModelTypeConst.ITV, ttv_credential, GenerationVideoModel),
]
