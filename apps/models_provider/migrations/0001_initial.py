...
def save_default_embedding_model(apps, schema_editor):
    ...
    # 设置默认值，避免 None 值违反数据库约束
    cache_folder = CONFIG.get('EMBEDDING_MODEL_PATH', '/opt/maxkb-app/model')
    model_name = CONFIG.get('EMBEDDING_MODEL_NAME', 'shibing624/text2vec-base-chinese')
