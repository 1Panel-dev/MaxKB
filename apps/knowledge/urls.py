...
urlpatterns = [
    ...
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/sync_setting', views.KnowledgeView.KnowledgeSyncSetting.as_view()),
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/sync_log/<int:current_page>/<int:page_size>', views.KnowledgeView.KnowledgeSyncLog.as_view()),
    ...
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/image/preview', views.ImageDocumentView.Preview.as_view()),
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/image/preview/<str:preview_id>', views.ImageDocumentView.PreviewOperate.as_view()),
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/image/batch_create', views.ImageDocumentView.BatchCreate.as_view()),
