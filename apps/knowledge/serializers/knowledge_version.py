...
class KnowledgeWorkflowVersionSerializer(serializers.Serializer):
    ...
    class Operate(serializers.Serializer):
        workspace_id = serializers.CharField(required=False, allow_null=True, allow_blank=True, label=_("Workspace ID"))
        knowledge_id = serializers.UUIDField(required=True, label=_("Knowledge ID"))
        knowledge_version_id = serializers.UUIDField(required=True, label=_("Knowledge version ID"))
        ...
        def one(self, with_valid=True):
            ...
            knowledge_version = (
                ...
                .filter(knowledge_id=self.data.get("knowledge_id"), id=self.data.get("knowledge_version_id"))
                .first()
            )
