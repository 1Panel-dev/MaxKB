...
def sync_web_knowledge(knowledge_id: str, user_id, url: str, selector: str):
...
def sync_replace_web_knowledge(knowledge_id: str, user_id, url: str, selector: str):
...
def sync_web_document(knowledge_id, user_id, source_url_list: List[str], selector: str):
