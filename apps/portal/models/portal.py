...
class Portal(AppModelMixin):
    ...
    # 基础信息
    name = models.CharField(max_length=64, verbose_name="门户名称", default="智能体门户")

    description = models.TextField(null=True, blank=True, max_length=256, verbose_name="门户描述")
    ...
    auth_config = models.JSONField(default=dict, blank=True, verbose_name="身份认证配置")
